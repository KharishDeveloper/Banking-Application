...
public class BankingServicesDB {
	...
	public static void SetPinDBLogic() throws SQLException {
...
//		BankingServicesDB.PinChecking(con, BankingServices.Pin);
	...
	public static void PinNullInfo(Connection con) throws SQLException {
...
//			pin=b.getInt(1);
	...
	public static void PinChecking(Connection con, String pin1) throws SQLException {
...
//		
	...
	public static void UserNameCheckingAtSetPin(Connection con, String users) throws SQLException {
	...
	public static void FinalPinSetting() throws SQLException {
...
//		
	...
	public static int WithdrawMoneyChecking(Connection con, String pin) throws SQLException {
		String sql = "select BankBalance,pin from accountdetails where Mail=?;";
	...
	public static void TransferUserChecking(Connection c) throws SQLException {
...
//			TransferringMoney(c);
	...
	public static void GettingDefaultUserName(Connection c) throws SQLException {
		String sql = "select UserName from usercreation where Mail=?;";
		PreparedStatement stmt = c.prepareStatement(sql);
		stmt.setString(1, BankLogin.mail);
		ResultSet set = stmt.executeQuery();
...
//			BankingServices.user1=set.getString(1);
			System.out.println("getting enetered userid");
			while (set.getString(1).equals(BankingServices.AnotherUserName)) {
				System.out.println("Entered your username");
				System.out.println("unable to transfer to self !!!");
				System.out.println("please enter username to transfer :");
...
//			}
	...
	public static void GettingMail(Connection c) throws SQLException {
	...
	public static void TransferringMoney(Connection c) throws SQLException {
		...
		stmt1.setString(3, Constants.generation(11));
